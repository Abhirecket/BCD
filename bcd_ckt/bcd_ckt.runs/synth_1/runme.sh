...
HD_PWD='C:/Users/Abhik/Documents/my_vivado_project/bcd_ckt/bcd_ckt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_ckt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_ckt.tcl
